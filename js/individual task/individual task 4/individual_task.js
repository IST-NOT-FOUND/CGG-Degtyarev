...
var verticesRedColor=0, verticesGreenColor=0, verticesBlueColor=0;
...
function initBuffers() { 
 ...
 // установка буфера вершин
  ...
  indexBuffer = gl.createBuffer();
    ...
    var сolors = [
        verticesRedColor, verticesGreenColor, verticesBlueColor,
        verticesRedColor, verticesGreenColor, verticesBlueColor,
        verticesRedColor, verticesGreenColor, verticesBlueColor,
        verticesRedColor, verticesGreenColor, verticesBlueColor,
...
function changeColor(){
    verticesRedColor=document.getElementById("R").value/255;
    verticesGreenColor=document.getElementById("G").value/255;
    verticesBlueColor=document.getElementById("B").value/255;    
